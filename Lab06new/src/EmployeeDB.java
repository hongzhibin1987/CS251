...
// create a DBmanager class to manage all connection, disconnections, and queries.
// option B: model class/object- all fields we needs that
// future UML and flowchart to better guide the mindflow
 */
